...
class CafeForm(FlaskForm):
    ...
    rating= SelectField('Cofee Rating', validators=[DataRequired()],choices=["☕️", "☕☕", "☕☕☕", "☕☕☕☕", "☕☕☕☕☕"])
...
def add_cafe():
    ...
    if form.validate_on_submit():
        ...
        with open('cafe-data.csv', mode='a', encoding='utf-8') as file:
            file.write(f"\n {form.cafe.data},"f"{form.Location.data},"f"{form.Open.data},"f"{form.Close.data},"f"{form.rating.data},"f"{form.wifi.data},"f"{form.power.data}")
